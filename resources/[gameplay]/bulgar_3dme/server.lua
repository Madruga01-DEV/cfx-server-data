RegisterCommand("me", function(source , args, rawCommand)
	...
	TriggerClientEvent('chat:me', -1, source, text, time)
end, false)
...
Citizen.CreateThread(function()
	if GetCurrentResourceName() ~= "bulgar_3dme" then -- There will be problems with the script if the name is changed...
		print("^1=====================================")
		print("^1SCRIPT NAME OTHER THAN ORIGINAL")
		print("^1THERE WILL/MAY BE PROBLEMS WITH THE SCRIPT IF THE NAME IS CHANGED")
		print("^1CHANGE NAME TO: ^2bulgar_3dme^1")
		print("^1=====================================^0")
	end
end)
--
